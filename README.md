...
<i><b>A Docker Compose project to run on servers with spare CPU, RAM, and bandwidth.</b><br/>Help the world by contributing your unused computing power to good causes.</i>
